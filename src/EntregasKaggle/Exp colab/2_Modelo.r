...
a_sacar <- c('ct_0_mrentabilidad',
    'ct_0_mrentabilidad_annual',
    'ct_0_mcomisiones',
    'ct_0_mactivos_margen',
    'ct_0_mpasivos_margen',
    'ct_0_ctarjeta_visa_debitos_automaticos',
    'ct_0_mttarjeta_visa_debitos_automaticos',
    'ct_0_ccomisiones_otras',
    'ct_0_mcomisiones_otras',
    'ct_0_chomebanking_transacciones', 'lag_ct_0_mrentabilidad_6', 'lag_ct_0_mrentabilidad_12', 'lag_ct_0_mrentabilidad_3',
    'lag_ct_0_mrentabilidad_annual_6', 'lag_ct_0_mrentabilidad_annual_12', 'lag_ct_0_mrentabilidad_annual_3',
    'lag_ct_0_mcomisiones_6', 'lag_ct_0_mcomisiones_12', 'lag_ct_0_mcomisiones_3',
    'lag_ct_0_mactivos_margen_6', 'lag_ct_0_mactivos_margen_12', 'lag_ct_0_mactivos_margen_3',
    'lag_ct_0_mpasivos_margen_6', 'lag_ct_0_mpasivos_margen_12', 'lag_ct_0_mpasivos_margen_3',
    'lag_ct_0_ctarjeta_visa_debitos_automaticos_6', 'lag_ct_0_ctarjeta_visa_debitos_automaticos_12', 'lag_ct_0_ctarjeta_visa_debitos_automaticos_3',
    'lag_ct_0_mttarjeta_visa_debitos_automaticos_6', 'lag_ct_0_mttarjeta_visa_debitos_automaticos_12', 'lag_ct_0_mttarjeta_visa_debitos_automaticos_3',
    'lag_ct_0_ccomisiones_otras_6', 'lag_ct_0_ccomisiones_otras_12', 'lag_ct_0_ccomisiones_otras_3',
    'lag_ct_0_mcomisiones_otras_6', 'lag_ct_0_mcomisiones_otras_12', 'lag_ct_0_mcomisiones_otras_3',
    'lag_ct_0_chomebanking_transacciones_6', 'lag_ct_0_chomebanking_transacciones_12', 'lag_ct_0_chomebanking_transacciones_3')

a_poner <- c('ct_it_mrentabilidad',
...
lista_ct_arbitraria <-  setdiff(lista_ct_0, a_sacar)
lista_ct_arbitraria <- Reduce(union, c(lista_ct_arbitraria, a_poner))
print(lista_ct_arbitraria)

# meses donde se entrena el modelo
PARAM$input$training <- c(201905, 201908, 201910, 202006, 202012)
...
datasets <- c("lista_ct_arbitraria", "lista_ct_0", "lista_ct_it", "lista_ct_median_6m", "lista_ct_mean_6m")
