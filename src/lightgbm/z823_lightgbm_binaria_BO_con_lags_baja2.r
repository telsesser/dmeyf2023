...
PARAM$input$training <- c(201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
