...
PARAM <- list()
PARAM$experimento <- "final_sinLags_2_bjas123"
...
dataset[, clase01 := ifelse(clase_ternaria_2 %in% c("BAJA+3", "BAJA+2", "BAJA+1"), 1L, 0L)]
...
tb_entrega <- dapply[, list(numero_de_cliente, foto_mes, clase_ternaria_2)]
